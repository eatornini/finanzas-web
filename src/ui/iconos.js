...
// Logo de la app: "savings" de Material Symbols, relleno (FILL=1) — path
// extraído directo de la fuente vendoreada (ver assets/icons/icono.svg,
// mismo path). A diferencia de svg(), es un ícono sólido (fill, no stroke).
export const logoAppIcono = () => {
  ...
  p.setAttribute(
    "d",
    "M237 120Q214 120 192.5 136.0Q171 152 164 175Q139 259 123.0 320.5Q107 382 97.5 428.5Q88 475 84.0 511.0Q80 547 80 580Q80 672 144.0 736.0Q208 800 300 800H500Q527 836 568.5 858.0Q610 880 660 880Q685 880 702.5 862.5Q720 845 720 820Q720 814 718.5 808.0Q717 802 715 797Q711 786 707.5 775.0Q704 764 702 751L793 660H840Q857 660 868.5 648.5Q880 637 880 620V410Q880 397 872.5 387.0Q865 377 852 372L767 344L717 177Q709 151 688.0 135.5Q667 120 640 120H560Q527 120 503.5 143.5Q480 167 480 200H400Q400 167 376.5 143.5Q353 120 320 120ZM240 200H320Q320 200 320.0 200.0Q320 200 320 200V280H560V200Q560 200 560.0 200.0Q560 200 560 200H640Q640 200 640.0 200.0Q640 200 640 200L702 406L800 439V580H760L620 720Q620 740 622.5 759.0Q625 778 630 796Q601 788 579.0 768.5Q557 749 547 720H300Q242 720 201.0 679.0Q160 638 160 580Q160 539 181.0 439.5Q202 340 240 200Q240 200 240.0 200.0Q240 200 240 200ZM640.0 520.0Q657 520 668.5 531.5Q680 543 680.0 560.0Q680 577 668.5 588.5Q657 600 640.0 600.0Q623 600 611.5 588.5Q600 577 600.0 560.0Q600 543 611.5 531.5Q623 520 640.0 520.0ZM480 600Q497 600 508.5 611.5Q520 623 520.0 640.0Q520 657 508.5 668.5Q497 680 480 680H360Q343 680 331.5 668.5Q320 657 320.0 640.0Q320 623 331.5 611.5Q343 600 360 600ZM240 200Q240 200 240.0 200.0Q240 200 240 200Q202 340 181.0 439.5Q160 539 160 580Q160 638 201.0 679.0Q242 720 300 720H547Q557 749 579.0 768.5Q601 788 630 796Q625 778 622.5 759.0Q620 740 620 720L760 580H800V439L702 406L640 200Q640 200 640.0 200.0Q640 200 640 200H560Q560 200 560.0 200.0Q560 200 560 200V280H320V200Q320 200 320.0 200.0Q320 200 320 200Z"
  );
  g.appendChild(p);
  nodo.appendChild(g);
  return nodo;
